...
#p0 = [np.array(initial) + np.array([random.uniform(-4.50,5.00),random.uniform(-0.01,0.01),random.uniform(-0.5,0.5),random.uniform(-20,20),random.uniform(-10,10)],) for i in range(nwalkers)]
p0 = [np.array(initial) + np.array([random.uniform(-4.9,4.0),random.uniform(-0.03,0.03),random.uniform(-0.5,0.5)],) for i in range(nwalkers)]
