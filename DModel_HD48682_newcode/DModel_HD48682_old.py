...
lam = [30, 32, 34, 70.0,  100.0,  160.0,  250.0,  350.0,  850.0]
flx = [0.148, 0.142, 0.136, 0.290,  0.275,  0.177,  0.09,   0.025,  0.0039]
unc = [0.013, 0.017, 0.020, 0.038,  0.007,  0.024,  0.015,  0.008,  0.0008]
#unc = 3*unc
#IRS Spectrum
#HD 48682
...
##Stellar Spectrum##
##Stellar Spectrum##
#HD 48682 Stellar flux values
#Import Model Atmosphere values
f_spek = np.loadtxt('Spek_6100.txt', dtype=[('wave', float),('fspek', float)])
...
flux_sa = 35.91*flux_nu/np.max(flux_nu)
...
#Extract variables and uncertainties
