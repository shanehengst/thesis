...
#Inner: AS Outer: DI
#sm_outer = [4.665 ,2.24,1.698]
#dfrac_outer = [0.45959 , 0.09821, 0.06349]
#q_outer = [ 3.646, 0.06,0.049 ]
#
#sm_inner = [ 3.69,4.30 ,1.87 ]
#dfrac_inner = [ 0.09042, 0.01667, 0.0454]
#q_inner = [ 3.77,0.17, 0.27]
...
direcsav = '/'+object+'_rm1_'+str(rm1)+'_rm2_'+str(rm2)+'_sm1_'+str(sm_outer[0])+'_sm2_'+str(sm_inner[0])+'_inner'+ci+'_outer'+co
...
#SED_outerbelt = DustyMM(sm,smax_r,dfrac,qv,rm,rw,rin,rout,'diice_hypv2')
[df_rbins_p, df_rbins_pb, df_rbins_dN, df_rbins_dNb, df_rbins_dM,df_rbins_dMb, df_fluxsm, df_fluxsmb, y_values_nb, y_values_b, grainsizes,gr_blowout,MPerb,SED_total2,SED_total_nb2,SED_outerbelt,SED_disc_nb2] = BetaGrains(sm,smax_r,dfrac,qv,rm1,rw1,rin,rout,100,comp_outer)
